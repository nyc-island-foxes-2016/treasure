...
ActiveRecord::Schema.define(version: 20160128220610) do
  ...
  create_table "matches", force: :cascade do |t|
    t.integer  "swipe1_id",  null: false
    t.integer  "swipe2_id",  null: false
    t.datetime "swapped_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  add_index "matches", ["swipe1_id"], name: "index_matches_on_swipe1_id", using: :btree
  add_index "matches", ["swipe2_id"], name: "index_matches_on_swipe2_id", using: :btree
  ...
  create_table "swipes", force: :cascade do |t|
    ...
    t.integer  "judged_item_id", null: false
